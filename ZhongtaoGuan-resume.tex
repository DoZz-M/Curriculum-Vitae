...
\begin{section}{Publication}
 \begin{enumerate}
     \item \textbf{Zhongtao Guan}, Jun Wan, Yu Liu, Dian Lu, Mengzhao Duan and Renke Huang. “Accurate Single-Ended Fault Location for Cable-OHL Hybrid Transmission Lines”, in Power and Energy Society General Meeting (PESGM), 2023. %\textbf{h5:82}
...
\sectiontable{Awards}{
    \entry{Excellent Student}{Top 3\% \hfill \textit{2022}}
    ...
    \entry{Excellent Student}{Top 1-2\% \hfill \textit{2023}}
    \entry{Outstanding Individual in Industrial Practice}{ \hfill \textit{2023}}
}
\begin{section}{Skills and Courses}
 \item{Programming Skills and Software: C/C++, Python, MATLAB, Simulink, Code Composer Studio, Altuim Designer, Solidworks, AMPL, Kicad}
\end{section}
\end{document}
